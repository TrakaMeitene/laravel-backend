...
<head>
    ...
    <title>Pieraksts Pie paziņojums</title>
</head>
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #dddddd;">
        ...
        <div style="padding: 20px; text-align: center;">
            <h1 style="color: #333333;">Vizīte atcelta!</h1>
            ...
            <table style="width: 100%; margin: 20px 0; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="color: #333333; font-size: 16px; padding: 10px; border: 1px solid #dddddd;">{{$client['name']}}</td>
                </tr>
                @isset($request->cancelreason)
                <tr>
                    <td style="color: #333333; font-size: 16px; padding: 10px; border: 1px solid #dddddd;">Piezīmes:</td>
                    <td style="color: #333333; font-size: 16px; padding: 10px; border: 1px solid #dddddd;">{{$request['cancelreason']}}</td>
                </tr>
                @endisset
            </table>
        </div>
